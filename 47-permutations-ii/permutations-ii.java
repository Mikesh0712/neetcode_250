class Solution {
    ...
    public void solve (int nums[],List<Integer>ds,List<List<Integer>>ans,boolean vis[]){
        ...
        for(int i=0;i<nums.length;i++){
            ...
            if (i > 0 && nums[i] == nums[i - 1] && !vis[i - 1])//dupliacte hateiba paen like [1,1,2] 1st 1 then taku store kar as seita not visited thila but 2nd 1 ta as visited sethipaen taku ignore 
            continue;
